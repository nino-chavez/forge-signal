...
import { checkVoice, type VoiceCheckResult } from '../voice/voice-checker.js';
...
export class Editor {
  ...
  private async attemptFix(
    ...
    const systemInstruction = `You are an editor fixing voice consistency issues. Fix the content to match Nino's voice while preserving the strategic content.`;
