...
import { getVoiceInstructions } from '../voice/voice-guide.js';
...
export class GhostWriter {
  ...
  private buildSystemInstruction(input: GhostWriterInput): string {
    ...
    return `You are Nino's Ghost Writer for strategic content. Your role is to:
...
4. **Generate in Voice**: Write in Nino's voice—pattern recognition, provisional conclusions, showing the work
