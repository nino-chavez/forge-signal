...
import { parseDeckFromMarkdown } from '../templates/deck-template.js';
import { generateCSSVariables, getDesignTokens } from '../design-system/presentation-theme.js';
...
export async function exportToHTML(options: HTMLExportOptions): Promise<void> {
  const { title, content, outputPath, contentType, author = 'Nino Chavez' } = options;
